...
#include <sstream>
#include <chrono>
//base64编码文件解码为utf-8格式文件
void base64Toutf8()
// 读取文件
std::string readFileToutf8(std::string &filename)
{
...
public:
    ...
    */
    void spliteWord(const std::string &text,std::vector<std::string>&characters){
            int i = 0;
            while(i<words.size()){
...
int main()
{
    ...
    std::ifstream file("F:/c++/.vscode/AC/test.txt");
    if (!file)
    {
